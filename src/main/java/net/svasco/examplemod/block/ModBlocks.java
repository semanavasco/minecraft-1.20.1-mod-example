package net.svasco.examplemod.block;
...
import net.svasco.examplemod.block.custom.SoundBlock;
...
public class ModBlocks {
    ...
    public static final RegistryObject<Block> NETHER_SAPPHIRE_ORE = registerBlock("nether_sapphire_ore",
            () -> new DropExperienceBlock(BlockBehaviour.Properties.copy(Blocks.NETHERRACK).strength(1.5f).requiresCorrectToolForDrops(),
                    UniformInt.of(2, 7)));
