    ...
    private void trimmedArmorItem(RegistryObject<Item> itemRegistryObject) {
        if (itemRegistryObject.get() instanceof ArmorItem armorItem) {
            trimMaterials.entrySet().forEach(entry -> {
                ...
                ResourceLocation armorItemResLoc = new ResourceLocation(ExampleMod.MOD_ID, armorItemPath);
                ResourceLocation trimResLoc = new ResourceLocation(trimPath); // minecraft namespace
                ResourceLocation trimNameResLoc = new ResourceLocation(ExampleMod.MOD_ID, currentTrimName);
                ...
                this.withExistingParent(itemRegistryObject.getId().getPath(),
                        ...
                        .texture("layer0",
                                new ResourceLocation(ExampleMod.MOD_ID,
